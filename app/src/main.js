...
// Preview gating (CLAUDE.md rule 8c) - PREVIEW_EMAILS is NOT an admin list
// and must never feed isAdmin() or grant dashboard/moderation powers; it
// only unlocks user-visible features still in dark-launch preview.
const PREVIEW_EMAILS = ['keefefons@gmail.com', 'jessiahmarielle@gmail.com']
const FEATURES = { emoteSeries: 'preview' }
