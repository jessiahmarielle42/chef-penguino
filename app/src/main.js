...
const FEATURES = { shopPreviewFix: 'all', wishlist: 'all', emoteSeries: 'all', draggableFab: 'all', timerVolumeSlider: 'preview', timerNoDim: 'all', skipIntro: 'all', noDimControls: 'all' }  // 'preview' | 'all'
